        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <input type="number" class="form-control" placeholder="Disponibles" id="disponiblespa" aria-label="Cantidad" disabled />
            </div>
            <div class="col-sm-4">
              <label for="" class="form-label">Periodo</label>
              <input type="text" class="form-control" placeholder="Disponibles" id="periodo" aria-label="Cantidad" disabled />
              <br>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-3">
              ...
              <input type="number" class="form-control" placeholder="Disponibles" id="disponibles" aria-label="Cantidad" disabled />
            </div>
            <div class="col-sm-3">
              <label for="" class="form-label">Días Acumulados (Periodo Actual)</label>
              <input type="number" class="form-control" placeholder="Acumulados" id="acumulados" aria-label="Cantidad" disabled />
            </div>
            <div class="col-sm-3">
              <label for="" class="form-label">Días Ocupados</label>
              <input type="number" class="form-control" placeholder="Acumulados" id="ocupadas" aria-label="Cantidad" disabled />
            </div>
            <div class="col-sm-3">
              <label for="" class="form-label">Saldo Días</label>
              <input type="number" class="form-control" placeholder="Saldo" id="saldo" aria-label="Cantidad" disabled />
              <br>
            </div>
          </div>
          <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-sm-6">
              <label for="" class="form-label is-required">Trabajador</label>
              <input type="text" class="form-control" placeholder="Trabajador" id="utrabajador" aria-label="Nombre" />
            </div>
            <div class="col-sm-6">
              <label for="" class="form-label is-required">Fecha</label>
              <input type="text" class="form-control" placeholder="Fecha" id="ufechah" aria-label="Nombre" /> <br>
            </div>
          </div>
          <br>
          <h5>Fechas</h5>
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <label for="" class="form-label">Periodo</label>
              <input type="text" class="form-control" placeholder="Periodo" id="uperiodo" aria-label="Periodo" disabled />
              <br>
            </div>
            <div class="col-sm-4">
              <label for="" class="form-label is-required">Fecha Fin</label>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <form id="uploadimage" action="" method="post" enctype="multipart/form-data">
                <label for="" class="form-label is-required">Comprobante Goce</label>
                <div class="input-group mb-3">
                  <button class="btn btn-success" type="button" id="generarComprobanteG">Generar</button>
                  <input class="form-control" type="file" id="uimageg" accept="application/pdf" disabled />
                  <button class="btn btn-success" id="verComprobanteG">Ver</button>
                </div>
              </form>
              <br />
            </div>
