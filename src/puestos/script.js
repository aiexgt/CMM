...
const mostrar = () => {
  $.post("./api/puestos/mostrarPuestos.php", {}, (data, status) => {
...
const guardar = () => {
  ...
  if(nombre == ""){
    ...
    $.post("./api/puestos/guardarPuesto.php", {
      nombre: nombre,
...
const ver = (codigo) => {
  ...
  id_cambio = id;
  $.post(
    "./api/puestos/buscarDetalles.php",
    {
      id:id
    },
  ...
  if(nombre == ""){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.post(
          "./api/puestos/actualizarPuesto.php",
          {
            nombre:nombre,
            descripcion:descripcion,
            estado: estado,
...
const eliminar = (codigo) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.post(
        "./api/puestos/eliminarPuesto.php",
        {
          codigo: id,
        },
        (data, status) => {
