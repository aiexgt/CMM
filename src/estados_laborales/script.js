...
const mostrar = () => {
  $.post("./api/estados_laborales/mostrarEstadosLaborales.php", {}, (data, status) => {
...
const guardar = () => {
  ...
  if(nombre == ""){
    ...
    $.post("./api/estados_laborales/guardarEstadoLaboral.php", {
      nombre: nombre,
...
const ver = (codigo) => {
  ...
  id_cambio = id;
  $.post(
    "./api/estados_laborales/buscarDetalles.php",
    {
      id:id
    },
  ...
  if(nombre == ""){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.post(
          "./api/estados_laborales/actualizarEstadoLaboral.php",
          {
            nombre:nombre,
            descripcion:descripcion,
            id: id_cambio
...
const eliminar = (codigo) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.post(
        "./api/estados_laborales/eliminarEstadoLaboral.php",
        {
          codigo: id,
        },
        (data, status) => {
...
busqueda.addEventListener("keyup", () => {
  $.post(
    "./api/estados_laborales/buscarEstadoLaboral.php",
    {
