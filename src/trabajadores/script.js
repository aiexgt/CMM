...
//* Funciones
const mostrar = () => {
  $.post("./api/trabajadores/mostrarTrabajadores.php", {}, (data, status) => {
...
const guardar = () => {
  ...
  if(cui == ""){
    ...
    $.post("./api/trabajadores/guardarTrabajador.php", {
      cui,
      nombre,
      apellido,
      estado_civil,
...
const ver = (codigo) => {
  ...
  id_cambio = id;
  $.post(
    "./api/trabajadores/buscarDetalles.php",
    {
      id:id
    },
    function (data, status) {
      ...
      $.post("./api/trabajadores/actualizarPeriodos.php", {
...
const actualizarDoc = () => {
  ...
  if ($("#dpi").val() != "") {
    ...
    $.ajax({
      url: "./api/documentos/guardarDpi.php",
      type: "post",
      data: formData,
      contentType: false,
      processData: false,
  ...
  if ($("#cv").val() != "") {
    ...
    formData.append("id", id);
    $.ajax({
      url: "./api/documentos/guardarCv.php",
      type: "post",
      data: formData,
      contentType: false,
      processData: false,
  ...
  if ($("#apoliciaco").val() != "") {
    ...
    formData.append("id", id);
    $.ajax({
      url: "./api/documentos/guardarApoliciaco.php",
      type: "post",
      data: formData,
      contentType: false,
      processData: false,
  ...
  if ($("#apenal").val() != "") {
    ...
    formData.append("id", id);
    $.ajax({
      url: "./api/documentos/guardarApenal.php",
      type: "post",
      data: formData,
      contentType: false,
      processData: false,
  ...
  if(cui == ""){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.post(
          "./api/trabajadores/actualizarTrabajador.php",
          {
            cui: cui,
            nombre: nombre,
            apellido: apellido,
...
const eliminar = (codigo) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.post(
        "./api/trabajadores/eliminarTrabajador.php",
        {
          codigo: id,
        },
        (data, status) => {
...
const buscar = () => {
  ...
  if(tipoBusqueda == "t"){
    $.post("./api/trabajadores/buscarTrabajador.php", {
      tipo: tipoBusqueda,
...
$.post("./api/default-select/mostrarEstadoCivil.php", {}, (data, status) => {
  document.getElementById("estado_civil").innerHTML = data;
  document.getElementById("uestado_civil").innerHTML = data;
});

$.post("./api/default-select/mostrarPuestos.php", {}, (data, status) => {
...
$.post("./api/default-select/mostrarEstadoLaboral.php", {}, (data, status) => {
...
uselectPais.addEventListener("change", () => {
  $.post(
    "./api/empresas/mostrarDepartamentos.php",
    {
...
uselectDepartamento.addEventListener("change", () => {
  $.post(
    "./api/empresas/mostrarMunicipios.php",
    {
